...
void receive_controls_json(String topic, String msg) {
  ...
  analogWrite(21, dim_amt(lux_array[12]) *     temp_array[1]   * onOff_array[12] /100 );     //12High
  analogWrite(14, dim_amt(lux_array[12]) * (255-temp_array[1]) * onOff_array[12] /100 );     //12Low
...
void setup() { 
  ...
  digitalWrite(21, HIGH);    //12High
  digitalWrite(14, HIGH);    //12Low
  ...
  digitalWrite(21, LOW);    //12High
  digitalWrite(14, LOW);    //12Low
