...
// lux_array:  lux 0-95 {NA, lux1, lux2, lux3, lux4, lux5, lux6, lux7, lux8, lux9, lux10, lux11, lux12};
// temp_array:  {NA};
...
int mom_pin_array[]= {-99,13,4,14,16,27,17,26,18,25,19,33,23};
//int low_pins[]  = {-99,};
//int high_pins[] = {-99,};
//void t_write(int i) {
...
void receive_controls_json(String topic, String msg) {
  ...
  for (int i = 1; i<=12; i++) {        
    if (topic == String(device_id) + "/" + "lux" + String(i)) {
      lux_array[i] = msg.toInt();  // msg to this topic should be value between 0-95
    }
  }
